 ...
 * Centralized repository for Lucide SVGs as PHP array.
 */
...
class Lucide_Icons {
    /**
     * Get all Lucide SVGs as an associative array (key => SVG markup)
     * @return array
     */
    public static function all() {
        return [
            ...
            'github' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-github-icon lucide-github"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',
...
// AJAX handler for sharing icon SVG preview
add_action('wp_ajax_get_sharing_icon_svg', function() {
    $icon = isset($_POST['icon']) ? sanitize_text_field($_POST['icon']) : '';
    if (!$icon) {
        wp_send_json_error('No icon specified');
    }
    require_once __FILE__;
    $svg = Lucide_Icons::get($icon);
    if ($svg) {
